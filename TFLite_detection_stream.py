...
# Create a flag to indicate if the video stream is stopped
stopped = False

#for frame1 in camera.capture_continuous(rawCapture, format="bgr",use_video_port=True):

# Define a function to handle frame processing and GUI display
def process_frames():
    global stopped
...
# Start a separate thread to process frames and display GUI
